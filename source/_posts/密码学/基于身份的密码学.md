...
##### IBC下的秘密通信模型
   <img src="/chunk.github.io/images/544147b24eeba0526f3b09d6b3e5b41a.jpg" style="zoom:50%;" />
##### Key Generation Center (KGC)
   - 用途：用户选择自己的ID作为公钥
     KGC根据ID产生相应的私钥（用户的私钥从KGC那里获得）
   - KGC与CA的区别
     <img src="/chunk.github.io/images/8bc7f1d877d87dcd7254141b625f1a97.jpg" style="zoom:50%;" />
##### IBC的优缺点
   - 优点
     避免使用复杂的PKI系统
   - 缺点
